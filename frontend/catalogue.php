...
<head>
    ...
    <style>
        .sticky-bar { position: sticky; top: 72px; z-index: 40; }
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-[2rem] overflow-hidden border border-slate-100 shadow-sm group">
                <div class="relative h-52 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                </div>
                <div class="p-6">
                    <h3 class="text-lg font-black text-slate-800">Porsche 911 Carrera</h3>
                    <p class="text-blue-600 font-bold mb-4">$450 <span class="text-slate-400 text-[10px] uppercase">/ Day</span></p>
                    ...
                    <div class="flex gap-2 mb-6">
                        ...
                        <a href="details.php?id=1" class="flex-1 bg-slate-100 text-slate-600 py-3 rounded-xl text-xs font-bold text-center hover:bg-slate-200 transition">Voir Détails</a>
                    </div>
                </div>
            </div>  <div class="bg-white rounded-[2rem] overflow-hidden border border-slate-100 shadow-sm group">
                <div class="relative h-52 overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                </div>
                <div class="p-6">
