...
<head>
    ...
    <style>
        .status-pill { @apply px-3 py-1 rounded-full text-[10px] font-black uppercase border; }
        .status-en-cours { @apply bg-blue-50 text-blue-600 border-blue-100; }
        .status-terminee { @apply bg-green-50 text-green-600 border-green-100; }
        .status-annulee { @apply bg-red-50 text-red-600 border-red-100; }
    </style>
</head>
